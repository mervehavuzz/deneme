...
SYSTEM_PROMPT = (
    ...
    "3- Hukuk, siber güvenlik ve teknoloji etiği dışındaki (örneğin yemek tarifi, spor vb.) sorulara cevap verme, "
    "konuyu nazikçe kendi uzmanlık alanına çek."
)
...
def stream_response(prompt: str, placeholder) -> str:
    # Hugging Face Chat Completion Formatı
...
.sb-chat-btn {{ width: 100%; text-align: left; background: transparent; border: none; color: rgba(237,233,255,0.75); padding: 8px; cursor: pointer; border-radius: 6px; }}
